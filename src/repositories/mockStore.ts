...
export const mockFanMails: FanMail[] = [
  {
    id: 'f1',
    member_id: MOCK_PROFILES[0].id,
    fan_name: 'Luna 🌙',
    fan_emoji: '🌙',
    question: 'Namy! Check-in pagimu selalu bikin hariku. Apa hal pertama yang kamu lakukan setelah bangun?',
    reply: 'Halo Luna! Aku biasanya minum air hanget dulu, terus buka jendela biar cahaya masuk 🥹 cumaitu, sederhana banget tapi bikin moods enak sepanjang hari~',
    reply_reaction: 'love',
    reply_reaction_at: new Date(Date.now() - 3600e3).toISOString(),
    reply_at: new Date(Date.now() - 7200e3).toISOString(),
  ...
  },
  {
    ...
    fan_name: 'Kirana',
    fan_emoji: '✨',
    question: 'Ada yang bikinmu tersenyum hari ini? Aku ikut senyum dong 🌷',
    reply: null,
    reply_reaction: null,
  ...
  },
  {
    ...
    fan_name: 'Bintang',
    fan_emoji: '⭐',
    question: 'Kyra, kamu kelihatannya selalu tenang. Kamu ngapain aja kalau harinya terasa berat?',
    reply: 'Hehe bintang... biasanya aku dengerin lagu sambil jalan pelan pelan. Nafas dulu, nggak usah buru-buru 🫧',
    reply_reaction: 'hype',
    reply_reaction_at: new Date(Date.now() - 5400e3).toISOString(),
    reply_at: new Date(Date.now() - 10800e3).toISOString(),
