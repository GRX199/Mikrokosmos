...
export const mockFanQuestions: FanQuestion[] = [
  {
    id: 'f1',
    fan_name: 'Luna',
    fan_emoji: '🌙',
    question: 'Check-in pagi kalian selalu bikin hariku! Apa hal pertama yang kalian lakukan setelah bangun?',
    created_at: new Date(Date.now() - 86400e3).toISOString(),
    answers: [
      {
        id: 'a1',
        question_id: 'f1',
        member_id: MOCK_PROFILES[0].id,
        answer: 'Halo Luna! Aku biasanya minum air hanget dulu, terus buka jendela biar cahaya masuk 🥹 sederhana banget tapi bikin moods enak sepanjang hari~',
        reaction: 'love',
        reaction_at: new Date(Date.now() - 3600e3).toISOString(),
        created_at: new Date(Date.now() - 7200e3).toISOString(),
      },
      {
        id: 'a2',
        question_id: 'f1',
        member_id: MOCK_PROFILES[1].id,
        answer: 'Aku nyalain lagu favorit dulu biar bangunnya gak berat ☁️ lagu ngebutihin mood pagi banget',
        reaction: 'hype',
        reaction_at: new Date(Date.now() - 5400e3).toISOString(),
        created_at: new Date(Date.now() - 7000e3).toISOString(),
      },
    ],
  },
  {
    ...
    fan_name: 'Kirana',
    fan_emoji: '✨',
    question: 'Ada yang bikin kalian tersenyum hari ini? Aku ikut senyum dong 🌷',
    created_at: new Date(Date.now() - 7200e3).toISOString(),
    answers: [],
  },
  {
    ...
    fan_name: 'Bintang',
    fan_emoji: '⭐',
    question: 'Kalian kelihatannya selalu santai aja. Kalian ngapain aja kalau harinya terasa berat?',
    created_at: new Date(Date.now() - 172800e3).toISOString(),
    answers: [
      {
        id: 'a3',
        question_id: 'f3',
        member_id: MOCK_PROFILES[2].id,
        answer: 'Hehe bintang... biasanya aku dengerin lagu sambil jalan pelan-pelan. Nafas dulu, nggak usah buru-buru 🫧',
        reaction: 'hype',
        reaction_at: new Date(Date.now() - 5400e3).toISOString(),
        created_at: new Date(Date.now() - 10800e3).toISOString(),
      },
    ],
  },
];
